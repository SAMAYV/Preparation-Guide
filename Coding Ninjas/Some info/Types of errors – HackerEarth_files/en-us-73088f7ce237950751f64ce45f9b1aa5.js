I18n = {
  ...
  "translations": {
    ...
    "txt.help_center.views.admin.shared.recent_activity.comment_count": "Number of comments: {{count}}",
    ...
    "txt.help_center.controllers.community.post.errors.title_too_long": "The provided title is too long.",
    ...
    "txt.help_center.views.requests.new.multiselect_remove_value": "Press delete to remove",
    ...
    "txt.help_center.views.navbar.search_settings": "Search settings",
    ...
    "txt.help_center.views.mentions.pop_up.mention_rate_limit_exceeded": "You are temporarily blocked from mentioning due to searching too frequently",
    "txt.help_center.views.mentions.pop_up.mentionable_user_limit_exceeded": "You have reached the limit of mentionable users",
    "txt.help_center.views.admin.general_settings.zopim_deprecation.title": "Your Chat settings are moving",
    "txt.help_center.views.admin.general_settings.zopim_deprecation.text": "On April 30th, 2020, the Chat integration setting is moving to Support admin settings. You must re-enable this setting in the new location before that time (if you use Multibrand, you will need to re-enable this setting for each brand). To find the new setting location, click the <strong>Admin</strong> icon (%{admin_icon}) in the Support sidebar, then select <strong>Channels &gt; Widget</strong>. %{learn_more_link}",
    "txt.help_center.views.admin.general_settings.zopim_deprecation.learn_more": "Learn more",
    "txt.help_center.views.admin.general_settings.zopim_deprecation.learn_more_url": "https://support.zendesk.com/hc/en-us/articles/360037493613",
    "txt.help_center.views.admin.spam_filter.form.enabled_notice": "You are automatically protected from spam by Datavisor. The spam filter does not prevent all spam. %{learn_more_link}.",
    "date.abbr_day_names": [
      "Sun",
      "Mon",
      "Tue",
